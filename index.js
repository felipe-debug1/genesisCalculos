        ...
        {   
            ...
            if(ges)
            {
                if (dia == 5 && dia == 6)
                {
                    ...
                    if(value >= 1000000)
                    {
                        value += (Number(value.toString().substring(0, 6)) * 10) * 0.015
                    }
                ...
                else 
                {
                    if(value >= 1000000)
                    {
                        value += (Number(value.toString().substring(0, 6)) * 10) * 0.025
                    }
...
{   
    ...
    else
    {
        ...
        Swal.fire({
            ...
            html: `Para alcançar este montante você precisará de aproximadamente <strong>${i == 1 ? i + " dia" : i + " dias"}</strong> (sem levar em conta algumas variáveis)!`,
            icon: 'info',
            showConfirmButton: false
        })   
    }
